                  ...
                  <TableCell align="center" sx={{ borderBottom: "1px solid #f1f5f9", py: 2 }}>
                    {dansPeriode ? (
                      <Box sx={{ display: "flex", gap: 1, justifyContent: "center" }}>
                        <Button
                          variant={estPresent ? "contained" : "outlined"}
                          startIcon={<CheckCircleIcon />}
                          onClick={() => marquerPresence(s.id, "present")}
                          sx={{
                            borderRadius: 3,
                            textTransform: "none",
                            fontWeight: 600,
                            ...
                            py: 0.8,
                            ...(estPresent
                              ? { bgcolor: SUCCESS, "&:hover": { bgcolor: "#1b5e20" } }
                              : {
                                  borderColor: BORDER,
                                  color: TEXT,
                                  "&:hover": { borderColor: SUCCESS, color: SUCCESS, bgcolor: GREEN_LIGHT },
                                }),
                          }}
                        >
                          Présent
                        ...
                        <Button
                          variant={estAbsent ? "contained" : "outlined"}
                          startIcon={<CancelIcon />}
                          onClick={() => marquerPresence(s.id, "absent")}
                          sx={{
                            borderRadius: 3,
                            textTransform: "none",
                            fontWeight: 600,
                            ...
                            py: 0.8,
                            ...(estAbsent
                              ? { bgcolor: DANGER, "&:hover": { bgcolor: "#b71c1c" } }
                              : {
                                  borderColor: BORDER,
                                  color: TEXT,
                                  "&:hover": { borderColor: DANGER, color: DANGER, bgcolor: RED_LIGHT },
                                }),
                          }}
                        >
                          Absent
