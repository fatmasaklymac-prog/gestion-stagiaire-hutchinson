encadrant_content = r'''import { useState } from "react";
...
stagiaire_content = r'''import { useState } from "react";
import { useNavigate } from "react-router-dom";
...
with open("LoginEncadrant.jsx", "w", encoding="utf-8") as f:
    f.write(encadrant_content)
print("LoginEncadrant.jsx mis a jour.")

with open("LoginStagiaire.jsx", "w", encoding="utf-8") as f:
    f.write(stagiaire_content)
print("LoginStagiaire.jsx mis a jour.")

print("Termine : les 3 pages de connexion partagent maintenant le meme design premium.")
